...
|Проект 3  Исследование нескольких аспектов мобильной игры  (__[Plants&Gardens Analysis](https://github.com/a-volkov11/project_3)__)|A/B - тестирование, SQL, расчёт метрик (CR, ARPU, ARPPU, ARPAU). Проведение А/B-теста (Тест Шапиро-Уилка, T‑test Стьюдента, bootstrap ).|SQL, Python, библиотеки:pandas, pingouin, seaborn, matplotlib, numpy, scipy, requests|
###
